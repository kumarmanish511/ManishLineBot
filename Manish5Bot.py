		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                ...
                else:md+="[•]Comment [Off]\n⭐️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️⭐️\MANISH  CREATIONS⭐\n⭐️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️▫️⭐️"
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"MANISH🔛1▶️On")
                ki.sendText(msg.to,"MANISH🔛2▶️▶️On")
                kk.sendText(msg.to,"MANISH🔛3▶️▶️▶️On")
                kc.sendText(msg.to,"MANISH🔛4▶▶️▶️▶️On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendText(msg.to,"⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️")
              cl.sendText(msg.to,"Manish Creations😜")
