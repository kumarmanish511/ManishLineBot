...
helpMessage ="""☢▶️MANISH-GANG-TEAM◀️☢️
Owner : 👑🔷▶🇲αníѕ🇭◀🔷👑
◻️◼️◻️◼️◻️◼️◻️◼️◻️◼️◻️◼️◻️◼️◻️◼️◻️◼️◻️◼️◻️◼️◻️
☢️◄]·♦·[C̶̲̅ᴏ̶̲̅ᴍ̶̲̅ᴍ̶̲̅ᴀ̶̲̅ɴ̶̲̅ᴅ̶̲̅ ̶̲̅ɪ̶̲̅ɴ̶̲̅ ̶̲̅G̶̲̅ʀ̶̲̅ᴏ̶̲̅ᴜ̶̲̅ᴘ̶̲̅]·♦·[►☢️
...
[•]Creator
[•]Bot
☢️◄]·♦·Admin[C̶̲̅ᴏ̶̲̅ᴍ̶̲̅ᴍ̶̲̅ᴀ̶̲̅ɴ̶̲̅ᴅ̶̲̅]·♦·[►☢️
⚪️⚫️⚪️⚫️⚪️⚫️⚪️⚫️⚪️⚫️⚪️⚫️⚪️⚫️⚪️⚫️⚪️
[•]Cancel
[•]「Buka/Tutup」qr
[•]Mid Bot
[•]Speed/Sp
[•]Readers point(then)Check Readers
[•]Status/Set
[•]Gurl
[•]Jam「On/Off」
[•]Tag all/Tagall
...
[•]Readers point
[•]Check Readers
[•]manish leave(leave all bots)
[•]Banned @name mention
[•]Unban @Name mention
[•]Kill ban
[•]Protectgr On/Off
[•]Kick Mid here 
[•]Clear [for all invitation cancel 1/1]
[•]Mid @mentioned name here

>>[☢️▶️MANISH⏹CREATIONS◀️☢️]<<
👑🔷▶🇲αníѕ🇭◀🔷👑
-==================-
🔴❇️⭐️▶️҉P҉r҉o҉t҉e҉c҉t◀️⭐️❇️🔴
-==================-
"""
KAC=[cl,ki,kk,kc,ks]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Thanks for adding me as a friend CREATED BY MANISH
≫ BEST BOT MAKER Bot Protect ≪
≫ MANISH BOT PROTECT ≪
...
Idline:  http://line.me/ti/p/lMdfzcqu_S""",
    ...
    "clock":False,
    "cName":"MANISH-GANG-1 ",
    "cName2":"MANISH-GANG-2 ",
    "cName3":"MANISH-GANG-3 ",
    "cName4":"MANISH-GANG-4 ",
    "cName5":"MANISH-GANG-5 ",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":True,
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              random.choice(KAC).sendText(op.param1, "MANISH-AUTOBOTS-CANCEL😛")
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","manish","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye op","Kabur all","manish leave"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"MANISH-GANG-1-On")
                ki.sendText(msg.to,"MANISH-GANG-2-On")
                kk.sendText(msg.to,"MANISH-GANG-3- On")
                kc.sendText(msg.to,"MANISH-GANG-4- On")
                ks.sendText(msg.to,"Refreshing MANISH-BOTS\nPower Up")
                cl.sendText(msg.to,"MANISH-GANG-LOADING....\ Protect Group\nGroup is under protection")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "MANISH-GANG-BOTS SPEED LOADING  ⏳⌛⏳⌛")
      ...
      #-------------Fungsi Chat ----------------
                 ...
                 quote = ['Hello There i am a virtual bot Designed By Manish 😂😂😂.','Kese ho sab? ..\n pagal si','Hello ','Manish ','Weather uploading...','Manish Creations','How are you']
...
#---------------------
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "Welcome To This Group" + str(ginfo.name))
          random.choice(KAC).sendText(op.param1, "Founder Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
          random.choice(KAC).sendText(op.param1,"Welcome Dear😊\n APKA SWAGAT HE ISS GROUP PER😘\n AUTOBOTS-MANISH-CREATIONS")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "BYE MESSAGE\nMANISH-AUTOBOTS")
